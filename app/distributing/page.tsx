          ...
          <div>
            ...
            <div className="text-base md:text-lg text-primary leading-relaxed space-y-4">
              ...
              <p>
                ...
                industrial demands. Each of our products is formulated to
                provide optimal performance, backed by rigorous quality control
                to ensure purity, consistency, and reliability.
              </p>
            </div>
          </div>
